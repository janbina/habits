...
abstract class NavigationEvent: ViewEvent() {
    ...
    companion object {
        operator fun invoke(@IdRes actionId: Int, arguments: Bundle) = NavDirectionsNavigationEvent(object : NavDirections {
            override fun getActionId() = actionId
            override fun getArguments() = arguments
        })
        operator fun invoke(@IdRes actionId: Int, args: FragmentArgs) = NavDirectionsNavigationEvent(object : NavDirections {
            override fun getActionId() = actionId
