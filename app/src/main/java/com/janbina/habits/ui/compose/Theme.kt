...
private val HabitsDarkPalette = darkColors(
    primary = Blue200,
...
private val HabitsLightPalette = lightColors(
    primary = Blue500,
...
fun HabitsTheme(
    ...
    val myColors = colors ?: if (isDarkTheme) HabitsDarkPalette else HabitsLightPalette
